...
export function findAllByOwner(http: HttpClient, rootUrl: string, params?: FindAllByOwner$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseCarResponse>> {
